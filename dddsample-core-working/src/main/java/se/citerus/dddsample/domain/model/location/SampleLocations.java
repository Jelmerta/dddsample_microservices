...
public class SampleLocations {
  ...
  public static final Location TOKYO = new Location(new UnLocode("JPTOK"), "Tokyo"); // TODO! Changed functionality here. Think it's supposed to be JPTOK instead of JNTKO. Tests now fail because creation of data now only happens when "new" is called. Didn't figure out why it previously worked though.
